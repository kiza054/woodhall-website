...
class UserAdmin(CustomUserAdmin, ExportCSVMixin):
    ...
    fieldsets = (
        ...
        (_('Personal Information'), {'fields': ('first_name', 'last_name', 'section', 'second_section', 'photo_permission', 'theme')}),
    ...
    list_display = ('email', 'first_name', 'last_name', 'section', 'second_section', 'photo_permission', 'theme', 'is_staff', 'is_executive', 'is_superuser')
