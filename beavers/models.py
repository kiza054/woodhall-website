...
class Post(models.Model):
    ...
    likes = models.ManyToManyField(User, blank=True, related_name="beavers_blog_posts_likes")
...
class PostImage(models.Model):
    ...
    image = models.ImageField(upload_to='media/post_images/beavers/%Y/%B/', blank=True, null=True) # When in development remove 'media/' in upload_to
...
class File(models.Model):
    ...
    file = models.FileField(upload_to='media/beavers/documents/%Y/%B/') # When in development remove 'media/' in upload_to
