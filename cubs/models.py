...
class PostImage(models.Model):
    ...
    image = models.ImageField(upload_to='media/post_images/cubs/%Y/%B/', blank=True, null=True) # When in development remove 'media/' in upload_to
...
class File(models.Model):
    ...
    file = models.FileField(upload_to='media/cubs/documents/%Y/%B/') # When in development remove 'media/' in upload_to
