...
urlpatterns = [
    ...
    path('gallery', views.ImageGalleryView, name='main_website_gallery'),
    #path('gallery/upload', views.upload_images, name='main_website_gallery_upload'),
    path('gallery/upload', views.ImageAddView, name='main_website_gallery_upload'),
    path('gallery/category/add/', views.ImageCategoryAddView, name='main_website_gallery_add_category'),
    path('gallery/image/<str:pk>/', views.ImageDetailView, name='main_website_gallery_image_detail'),
