        ...
        var h, t, P = "ontouchstart" in lt,
            ...
            y = function() {
                ...
                V.on("touchstart." + Q + " mousedown." + Q, function(t) {
                    ...
                    if ("mousedown" == (t = t.originalEvent).type) c = t.clientX, h = t.clientY, e = V.height(), a = V.width(), o = H.height(), s = H.width(), n = V.position().left, i = V.position().top, l = parseFloat(H.data("translate-x")), r = parseFloat(H.data("translate-y")), R = !0;
                    else {
